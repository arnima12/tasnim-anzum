        ...
        <div className="navbar text-white fixed top-0 z-10 text-xl">
            <div className="navbar-start px-6">
                <div className="dropdown">
                    ...
                    <ul tabIndex={1} className="menu menu-compact dropdown-content mt-3 p-2 shadow rounded-box w-52 glow-btn">
                        {menuItems}
                    </ul>
                </div>
            ...
            <div className="navbar-end px-4">
                <Link to="https://mega.nz/file/5bNxmRRB#SR0uBatL9L8SpO_XZAJLVBiAbIjXQVQX1JDvTMrYdpc" download="Tasnim_Anzum.pdf">
